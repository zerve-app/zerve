// Zerve adapted this from expo-next-adapter:
// https://github.com/expo/expo-cli/blob/main/packages/next-adapter/document.js
...
html, body, #__next {
  ...
  margin: 0px;
  padding: 0px;
  /* Zerve: limit height to 100% so that scrollviews can fill the height */
  height: 100%;
}
#__next {
  flex-shrink: 0;
