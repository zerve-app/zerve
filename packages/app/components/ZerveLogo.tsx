  ...
  return (
    ...
    >
      <Svg width="100%" height="100%" viewBox="0 0 346 92">
        <Defs>
          <LinearGradient x1="5.314%" y1="53.351%" x2="145.631%" y2="35.253%" id="a">
            <Stop stopColor="#AC44BB" offset="0%" />
            <Stop stopColor="#0B3FC2" offset="100%" />
          </LinearGradient>
          <LinearGradient x1="5.314%" y1="64.741%" x2="145.631%" y2="-14.869%" id="b">
            <Stop stopColor="#AC44BB" offset="0%" />
            <Stop stopColor="#0B3FC2" offset="100%" />
          </LinearGradient>
          <LinearGradient x1="5.314%" y1="53.636%" x2="145.631%" y2="33.997%" id="c">
            <Stop stopColor="#AC44BB" offset="0%" />
            <Stop stopColor="#0B3FC2" offset="100%" />
          </LinearGradient>
          <LinearGradient x1="176.166%" y1="0%" x2="92.953%" y2="151.259%" id="d">
          ...
          <LinearGradient x1="210.863%" y1="0%" x2="104.765%" y2="151.259%" id="f">
            <Stop stopColor="#340FCF" offset="0%" />
            <Stop stopColor="#AD44BB" offset="100%" />
          </LinearGradient>
          <LinearGradient x1="241.912%" y1="0%" x2="115.336%" y2="151.259%" id="g">
            <Stop stopColor="#340FCF" offset="0%" />
            <Stop stopColor="#AD44BB" offset="100%" />
          </LinearGradient>
        </Defs>
