...
export type FlexibleObjectyJSONSchema = {
  type?:
    | "object"
    | "array"
    | "string"
    ...
    | "null";
  const?: any;
  enum?: Array<FlexibleObjectyJSONSchema>;
  oneOf?: Array<FlexibleObjectyJSONSchema>;
  title?: string;
  description?: string;
  $id?: string;
  $ref?: string;
  default?: any;
  properties?: Record<string, FlexibleJSONSchema>;
  items?: FlexibleJSONSchema;
};

export type FlexibleJSONSchema =
  | Array<FlexibleObjectyJSONSchema>
